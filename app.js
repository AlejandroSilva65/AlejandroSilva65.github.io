...
const RACES = [
  ...
  { n:4, name:'Barein', city:'Sakhir', date:'10-12 Abr', flag:'🇧🇭', country:'Barein', continent:'middleeast', length:'5.412 km', laps:'57', desc:'Sakhir combina largas rectas con tracción crítica a la salida de curva.', flagImg: raceFlagPath('Barein'), circuitImg: circuitPhotoPath('Barein') },
  { n:5, name:'Arabia Saudi', city:'Jeddah', date:'17-19 Abr', flag:'🇸🇦', country:'Arabia Saudi', continent:'middleeast', length:'6.174 km', laps:'50', desc:'Jeddah es rapidísimo, urbano y muy exigente por sus muros cercanos.', flagImg: raceFlagPath('Arabia Saudi'), circuitImg: circuitPhotoPath('Arabia Saudi') },
